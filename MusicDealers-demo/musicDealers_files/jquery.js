	...
	var methods = {
		init: function(options) {
			return this.each(function() {
		        ...
		        var	$steps		= $this.children('fieldset').not('hidden'),
		        	$step		= undefined,
		        	$legend		= undefined,
		        	description	= '',
		        	title		= '';
				...
				if (opt.finishButton) {
			        if ($finish.length) {
		        		...
		        		$finish.appendTo($this.find('p.' + id + '-buttons'));
			        } else {
        	...
        	$('<a/>', { id: id + '-back-' + index, href: 'javascript:void(0);', 'class': 'button-back ' + opt.backClass, html: opt.backLabel }).click(function() {
        	...
        	$('<a/>', { id: id + '-next-' + index, href: 'javascript:void(0);', 'class': 'button-next ' + opt.nextClass, html: opt.nextLabel }).click(function() {
