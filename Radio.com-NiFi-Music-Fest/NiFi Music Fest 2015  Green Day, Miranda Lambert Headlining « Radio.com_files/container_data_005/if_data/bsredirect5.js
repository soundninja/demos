...
function dv_baseHandler(){function B(d,b,c,e,k,a,t){var i,n,m;m=window._dv_win.dv_config&&window._dv_win.dv_config.bst2tid?window._dv_win.dv_config.bst2tid:dv_GetRnd();var H,B=window.parent.postMessage&&window.JSON,h=!0,q=!1;if("0"==dv_GetParam(d.dvparams,"t2te")||window._dv_win.dv_config&&!0==window._dv_win.dv_config.supressT2T)q=!0;if(B&&!1==q)try{q="https://cdn3.doubleverify.com/bst2tv3.html";window._dv_win&&(window._dv_win.dv_config&&window._dv_win.dv_config.bst2turl)&&(q=window._dv_win.dv_config.bst2turl);
...
20);h=!1}}catch(V){}q=d.rand;p="__verify_callback_"+q;q="__tagObject_callback_"+q;window[p]=function(a){try{if(void 0==a.ResultID)document.write(1!=a?d.tagsrc:d.altsrc);else switch(a.ResultID){case 1:a.Passback?document.write(decodeURIComponent(a.Passback)):document.write(d.altsrc);break;case 2:case 3:document.write(d.tagsrc)}}catch(b){}};var L="http:",M="http:",N="0";"https"==window._dv_win.location.toString().match("^https")&&(L="https:","https"==t.src.match("^https")&&(M="https:",N="1"));window[q]=
function(a){try{var b={};b.protocol=L;b.ssl=N;b.dv_protocol=M;b.serverPublicDns=a.ServerPublicDns;b.ServerPublicDns=a.ServerPublicDns;b.tagElement=t;b.impressionId=a.ImpressionID;window._dv_win.$dvbsr.tags.add(a.ImpressionID,b)}catch(c){}};void 0==d.dvregion&&(d.dvregion=0);var D="http:",O="0";"https"==window.location.toString().match("^https")&&(D="https:",O="1");try{for(var f=c,w=0;10>w&&f!=window.top;)w++,f=f.parent;c.depth=w;var j=R(c);n="&aUrl="+encodeURIComponent(j.url);i="&aUrlD="+j.depth;
var P=c.depth+e;k&&c.depth--}catch(W){i=n=P=c.depth=""}void 0!=d.aUrl&&(n="&aUrl="+d.aUrl);var C;e=function(){try{return!!window.sessionStorage}catch(a){return!0}};k=function(){try{return!!window.localStorage}catch(a){return!0}};j=function(){var a=document.createElement("canvas");if(a.getContext&&a.getContext("2d")){var b=a.getContext("2d");b.textBaseline="top";b.font="14px 'Arial'";b.textBaseline="alphabetic";b.fillStyle="#f60";b.fillRect(0,0,62,20);b.fillStyle="#069";b.fillText("!image!",2,15);
b.fillStyle="rgba(102, 204, 0, 0.7)";b.fillText("!image!",4,17);return a.toDataURL()}return null};try{f=[];f.push(["lang",navigator.language||navigator.browserLanguage]);f.push(["tz",(new Date).getTimezoneOffset()]);f.push(["hss",e()?"1":"0"]);f.push(["hls",k()?"1":"0"]);f.push(["odb",typeof window.openDatabase||""]);f.push(["cpu",navigator.cpuClass||""]);f.push(["pf",navigator.platform||""]);f.push(["dnt",navigator.doNotTrack||""]);f.push(["canv",j()]);var l=f.join("=!!!=");if(null==l||""==l)C="";
else{for(var e=function(b){for(var a="",c,d=7;0<=d;d--)c=b>>>4*d&15,a+=c.toString(16);return a},k=[1518500249,1859775393,2400959708,3395469782],l=l+String.fromCharCode(128),x=Math.ceil((l.length/4+2)/16),y=Array(x),j=0;j<x;j++){y[j]=Array(16);for(f=0;16>f;f++)y[j][f]=l.charCodeAt(64*j+4*f)<<24|l.charCodeAt(64*j+4*f+1)<<16|l.charCodeAt(64*j+4*f+2)<<8|l.charCodeAt(64*j+4*f+3)}y[x-1][14]=8*(l.length-1)/Math.pow(2,32);y[x-1][14]=Math.floor(y[x-1][14]);y[x-1][15]=8*(l.length-1)&4294967295;for(var l=1732584193,
f=4023233417,w=2562383102,E=271733878,F=3285377520,r=Array(80),z,s,u,v,G,j=0;j<x;j++){for(var g=0;16>g;g++)r[g]=y[j][g];for(g=16;80>g;g++)r[g]=(r[g-3]^r[g-8]^r[g-14]^r[g-16])<<1|(r[g-3]^r[g-8]^r[g-14]^r[g-16])>>>31;z=l;s=f;u=w;v=E;G=F;for(g=0;80>g;g++){var Q=Math.floor(g/20),S=z<<5|z>>>27,A;c:{switch(Q){case 0:A=s&u^~s&v;break c;case 1:A=s^u^v;break c;case 2:A=s&u^s&v^u&v;break c;case 3:A=s^u^v;break c}A=void 0}var T=S+A+G+k[Q]+r[g]&4294967295;G=v;v=u;u=s<<30|s>>>2;s=z;z=T}l=l+z&4294967295;f=f+s&
4294967295;w=w+u&4294967295;E=E+v&4294967295;F=F+G&4294967295}C=e(l)+e(f)+e(w)+e(E)+e(F)}}catch(X){C=null}c=(window._dv_win&&window._dv_win.dv_config&&window._dv_win.dv_config.verifyJSCURL?dvConfig.verifyJSCURL+"?":D+"//rtb"+d.dvregion+".doubleverify.com/verifyc.js?")+d.dvparams+"&num=5&srcurlD="+c.depth+"&callback="+p+"&jsTagObjCallback="+q+"&ssl="+O+"&refD="+P+"&htmlmsging="+(B?"1":"0")+"&guid="+m+(null!=C?"&aadid="+C:"");b="dv_url="+encodeURIComponent(b);if(!1==h||a)c=c+("&dvp_isBodyExistOnLoad="+
(h?"1":"0"))+("&dvp_isOnHead="+(a?"1":"0"));if((a=window[I("=@42E:@?")][I("2?46DE@C~C:8:?D")])&&0<a.length){h=[];h[0]=window.location.protocol+"//"+window.location.hostname;for(m=0;m<a.length;m++)h[m+1]=a[m];a=h.reverse().join(",")}else a=null;a&&(b+="&ancChain="+encodeURIComponent(a));if(!1==/MSIE (\d+\.\d+);/.test(navigator.userAgent)||7<new Number(RegExp.$1)||2E3>=n.length+i.length+c.length)c+=i,b+=n;if(void 0!=window._dv_win.$dvbsr.CommonData.BrowserId&&void 0!=window._dv_win.$dvbsr.CommonData.BrowserVersion&&
...
""));break}a=h=U();i=h===n?i:"";window._dv_win.$dvbsr.CommonData.BrowserId=a;window._dv_win.$dvbsr.CommonData.BrowserVersion=i;window._dv_win.$dvbsr.CommonData.BrowserIdFromUserAgent=n}c+="&brid="+a+"&brver="+i+"&bridua="+n;return c+"&eparams="+encodeURIComponent(I(b))}function R(d){try{if(1>=d.depth)return{url:"",depth:""};var b,c=[];c.push({win:window.top,depth:0});for(var e,k=1,a=0;0<k&&100>a;){try{if(a++,e=c.shift(),k--,0<e.win.location.toString().length&&e.win!=d)return 0==e.win.document.referrer.length||
0==e.depth?{url:e.win.location,depth:e.depth}:{url:e.win.document.referrer,depth:e.depth-1}}catch(t){}b=e.win.frames.length;for(var i=0;i<b;i++)c.push({win:e.win.frames[i],depth:e.depth+1}),k++}return{url:"",depth:""}}catch(n){return{url:"",depth:""}}}function I(d){new String;var b=new String,c,e,k;for(c=0;c<d.length;c++)k=d.charAt(c),e="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".indexOf(k),0<=e&&(k="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".charAt((e+
47)%94)),b+=k;return b}function U(){try{if("function"===typeof window.callPhantom)return 99;try{if("function"===typeof window.top.callPhantom)return 99}catch(d){}if(void 0!=window.opera&&void 0!=window.history.navigationMode||void 0!=window.opr&&void 0!=window.opr.addons&&"function"==typeof window.opr.addons.installExtension)return 4;if(void 0!=window.chrome&&"function"==typeof window.chrome.csi&&"function"==typeof window.chrome.loadTimes&&void 0!=document.webkitHidden&&(!0==document.webkitHidden||
...
var b=!1;try{var c=document.createElement("p");c.innerText=".";c.style="text-shadow: rgb(99, 116, 171) 20px -12px 2px";b=void 0!=c.style.textShadow}catch(e){}return 0<Object.prototype.toString.call(window.HTMLElement).indexOf("Constructor")&&b&&void 0!=window.innerWidth&&void 0!=window.innerHeight?5:0}catch(k){return 0}}this.createRequest=function(){var d=!1,b=window,c=0,e=!1;try{for(dv_i=0;10>=dv_i;dv_i++)if(null!=b.parent&&b.parent!=b)if(0<b.parent.location.toString().length)b=b.parent,c++,d=!0;
else{d=!1;break}else{0==dv_i&&(d=!0);break}}catch(k){d=!1}0==b.document.referrer.length?d=b.location:d?d=b.location:(d=b.document.referrer,e=!0);var a=document.getElementsByTagName("script");for(dv_i in a)if(a[dv_i].src){var t=a[dv_i].src;if(t=t&&t.match(/bsredirect5(_plain)?\.js\?callback=/)?t.replace(/^.+?callback=(.+?)(&|$)/,"$1"):null)if((this.redirect=eval(t+"()"))&&!this.redirect.done)return this.redirect.done=!0,b=B(this.redirect,d,b,c,e,a[dv_i]&&a[dv_i].parentElement&&a[dv_i].parentElement.tagName&&
"HEAD"===a[dv_i].parentElement.tagName,a[dv_i]),b+="&"+this.getVersionParamName()+"="+this.getVersion()}};this.isApplicable=function(){return!0};this.onFailure=function(){};this.sendRequest=function(d){dv_sendRequest(d);return!0};if(window.debugScript&&(!window.minDebugVersion||10>=window.minDebugVersion))window.DvVerify=B,window.createRequest=this.createRequest;this.getVersionParamName=function(){return"ver"};this.getVersion=function(){return"20"}};
