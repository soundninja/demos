/* Built by CCTRL03 on 2015-02-24 05:24:09*/
...
wnSetConfigVariable('wn.ads.uafconfig.local.handlers','simple');
wnSetConfigVariable('wn.ads.uafconfig.local.templates.dom','http://ad.doubleclick.net/[ad.type:dfpadtype]/[ad.wnccx];tile=[ad.sequence];sz=[ad.width]x[ad.height];ord=[page.rand];kw=[ad.wncc:lowercase]?');
wnSetConfigVariable('wn.ads.uafconfig.local.templates.inline','http://ad.doubleclick.net/[ad.type:dfpadtype]/[ad.wnccx];tile=[ad.sequence];sz=[ad.width]x[ad.height];kw=[ad.wncc:lowercase]?');
wnSetConfigVariable('wn.ads.uafconfig.local.templates.async','http://ad.doubleclick.net/pfadx/[ad.wnccx];tile=[ad.sequence];sz=2x2;ord=[page.rand];kw=[ad.wncc:lowercase]?');
wnSetConfigVariable('wn.video.general.landingpage','http://www.cbsradio.com/videos/');
wnSetConfigVariable('wn.video.general.helppage','http://www.cbsradio.com/video/WNFlashHelp.html');
...
wnSetConfigVariable('wn.video.site.assetformat1','wmv');
wnSetConfigVariable('wn.video.site.assetformat2','flv');
...
wnSetConfigVariable('wn.video.helppage','http://www.cbsradio.com/video/VideoHelp.htm?video=');
wnSetConfigVariable('wn.video.helppagemac','http://www.cbsradio.com/video/MacVideoHelp.htm?video=');
...
wnSetConfigVariable('wn.video.reporting.thirdparty','<scr\' + \'ipt id="WorldNow_ReportInclude_NielsenNetRatings" nielsenClientId="us-401780" nielsenCensusId="vc,b01" src="__contentdomain__/global/tools/video/Namespace_VideoReporting_NielsenNetRatings.js?ver=__includeversion__"><\/scr\' + \'ipt><scr\' + \'ipt id="WorldNow_ReportInclude_ComScore" language="JavaScript" src="__contentdomain__/global/tools/video/Namespace_VideoReporting_ComScore.js?ver=__includeversion__"><\/scr\' + \'ipt>');
wnSetConfigVariable('wn.video.reporting.enableexpressreporting',true);
wnSetConfigVariable('wn.video.standalone.enabled',true);
...
wnSetConfigVariable('wn.video.widgets.enableadvertisingzone',false);
...
wnSetConfigVariable('wn.video.landingpage.flash','http://www.cbsradio.com/videos/');
...
wnSetConfigVariable('wn.affiliatename','CBSRadio');
wnSetConfigVariable('wn.affiliateno',780);
wnSetConfigVariable('wn.ref.machinename','CCTRL03');
wnSetConfigVariable('wn.ref.builddatetime','2015-02-24 05:24:09');
wnSetConfigVariable('wn.rootassociations.home',129908);
wnSetConfigVariable('wn.rootassociations.weather',129909);
wnSetConfigVariable('wn.rootassociations.search',129914);
wnSetConfigVariable('wn.rootassociations.pop_video_search',129915);
wnSetConfigVariable('wn.rootassociations.pop_video_top',129916);
wnSetConfigVariable('wn.rootassociations.weatheralerts',129910);
wnSetConfigVariable('wn.rootassociations.mostpopularstory',188979);
wnSetConfigVariable('wn.rootassociations.mostpopularvideo',188980);
wnSetConfigVariable('wn.globalimageprefix','http://images.worldnow.com/global');
wnSetConfigVariable('wn.staticimagefarmprefix','http://CBSRadio.images.worldnow.com');
wnSetConfigVariable('wn.baseurl','cbsr.cbsradio.com');
...
wnSetConfigVariable('wn.jsincludesversion2','v3-15-51');
