...
jQuery(document).ready(function() {
	jQuery('li.menu-item > ul.sub-menu > li.menu-item > ul.sub-menu')
		.hide()
		.each(function(){
			var $subsubnav = jQuery(this);
			$subsubnav.parent().addClass('subnav-arrow-down');
			$subsubnav.parent().hover(
				function(){
					$subsubnav.show().css('left', $subsubnav.parent().position().left + 'px').css('width', '185px').children().css('width', '185px');
				},
				function(){ $subsubnav.hide(); }
			);
		});	
