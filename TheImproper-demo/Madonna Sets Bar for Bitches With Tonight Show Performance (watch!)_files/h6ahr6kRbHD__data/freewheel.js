...
$pdk.ns("$pdk.plugin.freewheel.admanager");
$pdk.plugin.freewheel.admanager.FlashAdManager=$pdk.extend($pdk.plugin.freewheel.admanager.NativeAdManager,{constructor:function(c,a,e,b){$pdk.plugin.freewheel.admanager.FlashAdManager.superclass.constructor(c,a,e);
this.ready=false;
this._callback=e;
var d=this;
this.addEventListener("urn:theplatform:freewheel:ready",function(f){if(f){d.ready=true;
d._callback.call()
}});
if(b){a.loadLayer("flash","freewheel",b)
}else{a.loadLayer("flash","freewheel",$pdk.scriptRoot+"/swf/FreeWheelAdManagerLoader.swf")
}$pdk.ns("tv.freewheel");
