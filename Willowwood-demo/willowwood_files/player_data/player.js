  ...
  $(function() {
    ...
    window.Track = Backbone.Model.extend({
      ...
      getWave: function(callback) {
        var that;
        that = this;
        return $.getJSON('https://wave64.herokuapp.com/w?callback=?', {
    ...
    window.AppView = Backbone.View.extend({
      ...
      defaults: {
        ...
        links: ['https://soundcloud.com/qotsa/sets/test'],
        random: false,
        redirect: 'https://stratus.soundcloud.com/callback.html',
        user: true,
        stats: true,
        volume: 50
      },
    ...
    getScaledImageData = function(image) {
      var color, e, height, isImageData, lastIndex, orig, origCtx, origImageData, origWidth, populateScaledImagedData, precise, scaleX, scaleY, scaled, scaledCtx, scaledImageData, width, x, y;
