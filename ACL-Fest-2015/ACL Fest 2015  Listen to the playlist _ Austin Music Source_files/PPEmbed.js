...
var _ndnBuyerId = 'austinamericanstatesman_90105';
var distributorId = '90105';
var partnerId = '472';
  ...
  return $.Deferred(function(deferred){
    ...
    if ('XDomainRequest' in window && window.XDomainRequest !== null && ie_version.major < 10) {
      ...
      var responseAJAX = $.ajax({
		...
		deferred.resolve(JSON.parse(responseAJAX.responseText));
	}
...
(function($){
 getPlacements().done(function(placements){
    ...
    var jsonRecommendations = (typeof(placements.recData) !== 'undefined' && typeof(placements.recData.videos) !== 'undefined') ? placements.recData.videos : [];
    var recIndex = 0;
